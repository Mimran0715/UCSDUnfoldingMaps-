...
public class CityMarker extends SimplePointMarker {
	...
	//Mal - constructor - makes citymarker with previous classes constructor - Simple Point Marker
	public CityMarker(Location location) {
		super(location);
	}
	
	// other contsructor - this one using a city, instead of a location
